...
{
	Lcd_cursor(&lcd,0,1);
	Lcd_string(&lcd,"Nevathitha\n");

	Lcd_cursor(&lcd,1,1);
	Lcd_string(&lcd,"212224230185");
}
void SystemClock_Config(void)
{
...
## Output screen shots of proteus  :
 ...
 <img width="1670" height="951" alt="Screenshot 2026-02-27 093655" src="https://github.com/user-attachments/assets/1d8b8c8b-0f32-47e7-a8ea-baecb496542c" />

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 

 <img width="1228" height="861" alt="image" src="https://github.com/user-attachments/assets/b75b5c3e-aa8e-445b-8475-1438b1f7b71f" />
